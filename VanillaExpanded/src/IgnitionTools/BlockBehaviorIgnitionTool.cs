...
/// <summary>
/// Block behavior for blocks that can ignite ignitable blocks.
/// Forwards all interaction handling to <see cref="IgnitionToolLogic"/>.
/// </summary>
public sealed class BlockBehaviorIgnitionTool : BlockBehavior
{
    #region Constants
    public static string RegistryId => "IgnitionToolBlock";
    #endregion
    ...
    public BlockBehaviorIgnitionTool(Block block) : base(block)
    {
        /*
